    ...
    return (
      <footer className="nav-footer" id="footer">
        <section className="sitemap">
          ...
          <div>
            <h5>Docs</h5>
            <a href={this.docUrl('intro', this.props.language)}>Getting Started</a>
            <a href={this.docUrl('install', this.props.language)}>Install</a>
            <a href={this.docUrl('example', this.props.language)}>Example</a>
            <a href={this.docUrl('api-queries', this.props.language)}>API</a>
          </div>
          <div>
            <h5>Community</h5>
            <a
